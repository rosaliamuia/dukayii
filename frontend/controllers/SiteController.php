...
class SiteController extends Controller
{
    ...
    public function actionCarty()
    {
        return $this->render('carty');
    }
    ...
    public function createOrder($userId,$productId,$total){
        $model = New Orders();
        $data = ['Orders'=>['userId'=>$userId,'total'=>$total,'orderStatus'=>'Paid','createdBy'=>yii::$app->user->id]];
        if($model->load($data) && $model->save()){
    ...
    public function actionCheckoutf()
{
    $model = new \frontend\models\Checkout();
    ...
    //     if(!$model['productId']===$product['productId']->load($data) && $model->save()){
    //         return true; 
    //     }
    ...
    //     *SELECT SUM(quantity) FROM cartitems WHERE createdBy= :userId`, ['userId'=> Yii::$app->user->id])
    //     ->scalar();
